...
define config.name = _("{b}Lonely galaxy{/b}")
...
"Slow Ska Game Loop" by Kevin MacLeod
"Heartbreaking" by Kevin MacLeod
https://wav-library.net/zvuk-sireny-s-effektom-filtered-stereo-enhancer-fx-mp3 - звуковые эффекты

Sounds
Fire Sound by Spanac https://www.freesoundslibrary.com/fire-sound/

Most of sounds are from this website

Backgrounds by: Alexander Kashin
Sprites by:


please contact me if you are the author of sound effect. I assumed free license.
""")
...
define build.name = "Lonelygalaxy"
...
define config.save_directory = "Test-1577292599"
